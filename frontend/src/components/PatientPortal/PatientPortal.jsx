...
// ── Overview tab ──
function OverviewTab({ patient, appointments, onBook, onTabChange }) {
      ...
      <div className="pp-overview-cols">
        <div className="pp-card">
          <div className="pp-card-header">
            ...
            <button className="pp-card-link" onClick={() => onTabChange('appointments')}>View all →</button>
          </div>
          {!nextAppt ? (
    ...
    <div className="pp-page">
      ...
      <div className="pp-body">
        ...
        <main className="pp-main">
          {activeTab === 'overview' && (
            <OverviewTab patient={patient} appointments={appointments} onBook={() => setShowBooking(true)} onTabChange={setActiveTab} />
          )}
